                        ...
                        <div class="cart">
                            <form method="post">
                                ...
                                if(in_array($item['item_id'],$cos->getCartId($produs->getData('cos')) ?? [])){
                                    echo '<button type="submit" disabled class="in_cos" name="recomandate_submit">Produsul se afla in cos</button>';
                                }else

                                echo '<button type="submit" name="recomandate_submit">Adauga in cos</button>';
                                ?>
                            </form>
                        </div>
